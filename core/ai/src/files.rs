...
const NOISE: &[&str] = &[
    "file", "files", "my", "the", "a", "an", "from", "show", "find", "me", "all", "get", "list",
    "give", "recent", "that", "i", "in", "on", "of", "with", "any", "some", "look", "for", "about",
    "containing", "named", "called", "and",
    "downloaded", "download", "downloads", "edited", "modified", "changed", "updated", "created",
    "made", "saved", "opened",
    "search", "searches", "searching", "open", "reveal", "where", "are", "were", "is", "was",
    "did", "you", "your", "have", "had", "to", "please",
];

/// Time words the `window` grammar consumes; stripped so they don't leak into
/// the free-text terms.
const TIME_NOISE: &[&str] = &[
    "today", "tonight", "yesterday", "tomorrow", "week", "month", "year", "day", "days", "last",
    "this", "next", "past", "recent", "ago", "morning", "afternoon", "evening", "night", "weekend",
    "mon", "tue", "wed", "thu", "fri", "sat", "sun", "monday", "tuesday", "wednesday", "thursday",
    "friday", "saturday", "sunday", "jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep",
    "oct", "nov", "dec",
];
...
pub fn parse(query: &str, now_epoch: i64) -> Option<FileQuery> {
    ...
    let (start, end) = window.map(|w| (Some(w.start), Some(w.end))).unwrap_or((None, None));
