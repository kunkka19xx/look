...
- **Inner Gap** - gap between the top row, results list and preview (0-24 px). `0` is the classic framed panel; above 0 each becomes its own floating card. Saved as `inner_gap`
