...
- `query_retention_seconds` (how long the main query survives while Look is hidden, in seconds; the first open past it returns to the empty home screen; default 5, minimum 5, and `-1` keeps the query indefinitely)
